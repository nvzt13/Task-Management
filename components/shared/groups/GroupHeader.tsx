...
const GroupHeader: React.FC<GroupHeaderProps> = ({ group, isAdmin }) => {
  return (
    <header className="flex flex-col md:flex-row items-center justify-between border-b p-4 mb-4 bg-gradient-to-r from-gray-50 via-gray-100 to-gray-50 shadow-md rounded-md transition-colors duration-300">
